...
function getCarById(inventory,idNumber){
    return inventory.filter(function(inventory){
            return inventory.id === idNumber;
        })
       .map(function(inventory){
           return console.log('Car '+inventory.id + ' is a ' + inventory.car_make + " " + inventory.car_model)
       })
}
